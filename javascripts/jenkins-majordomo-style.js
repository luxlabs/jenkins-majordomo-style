...
.done(function(script, textStatus) {
    if(currentUrl != URL_LOGIN && currentUrl != URL_LOGIN_ERROR){
        Q('#newBuildQueue').popover({placement:'bottom', trigger:'click'});
    }
})
